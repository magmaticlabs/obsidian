 ...
 */
final class OwnersRelationshipTest extends RelationshipTestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    public function create_relationship()
    {
        ...
        $response = $this->post($this->route('owners.create', $model->id), $data);
    ...
    public function delete_relationship()
    {
        ...
        $response = $this->delete($this->route('owners.destroy', $model->id), $data);
        $this->validateResponse($response, 200);
